# Techtonic Proof of Concept Website Address
http://54.237.2.184:8080/

# Testing

In order to run our testing code, you must run the following commands while in the src/test directory:

- Run `npx mocha unit_test.mjs` to run our unit test
- Run `python behavior.py` to run the behavioral test
